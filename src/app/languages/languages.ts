...
export type TTranslationCode = 'switch-ui-left-right' | // Switch left/right UI
    ...
    'palettes-add' | // Add Palette
    'palettes-add-color' | // Add to Palette
    'palettes-name-prompt' | // Palette Name:
    'palettes-new-name' | // New Palette
    'palettes-default' | // Default Palette
    'palettes-delete-color' | // Delete this color from palette?
    'mci-hex' | // Hex
    'mci-copy' | // Copy
    'modal-ok' | // Ok
    'modal-cancel' | // Cancel
