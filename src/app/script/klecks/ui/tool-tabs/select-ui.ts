...
import modeSelectImg from 'url:/src/app/img/ui/procreate/selection.svg';
import modeMoveImg from 'url:/src/app/img/ui/procreate/transform.svg';
import { c } from '../../../bb/base/c';
import { TBooleanOperation, TSelectShape } from '../../select-tool/select-tool';
import defaultImSvg from 'url:/src/app/img/ui/procreate/select-replace.svg';
import unionImSvg from 'url:/src/app/img/ui/procreate/select-union.svg';
import subtractImSvg from 'url:/src/app/img/ui/procreate/select-subtract.svg';
import rectSvg from 'url:/src/app/img/ui/procreate/select-rect.svg';
import ellipseSvg from 'url:/src/app/img/ui/procreate/select-ellipse.svg';
import lassoSvg from 'url:/src/app/img/ui/procreate/select-lasso.svg';
import polySvg from 'url:/src/app/img/ui/procreate/select-poly.svg';
